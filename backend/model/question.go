...
type Question struct {
	...
	//[ 2] number                                         INT2                 null: false  primary: true   isArray: false  auto: false  col: INT2            len: -1      default: []
	...
	//[ 4] solution                                       VARCHAR              null: false  primary: false  isArray: false  auto: false  col: VARCHAR         len: -1      default: []
