<script>
  ...
  // https://github.com/carbon-design-system/carbon-components-svelte/src/TextArea/TextArea.svelte
  ...
  export let ref = null;
  import { WarningFilled20 } from "carbon-icons-svelte";
  $: errorId = `error-${id}`;
</script>
...
>
  ...
  <div class:bx--text-area__wrapper={true} data-invalid={invalid || undefined}>
    {#if invalid}
      <WarningFilled20 class="bx--text-area__invalid-icon" />
    {/if}
    <textarea
      bind:this={ref}
      bind:value
